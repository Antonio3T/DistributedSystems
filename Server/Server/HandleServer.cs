    ...
    public class HandleServer
    {
        ...
        private static void Connected(MClient Client)
        {
            if (Client.Client.Connected)
            {
                ...
                IPEndPoint ClientIP = (IPEndPoint)Client.Client.Client.RemoteEndPoint;
        ...
        private static void SendFile(MClient Client)
        {
            if (Client.Client.Connected)
            {
                string FilePath = @"C:\Users\PhyMo\Source\repos\P1\File Management\Data\Data Base\Coverage\Coverage.csv";
        ...
        private static void ReceiveFile(MClient Client, NetworkStream Stream)
        {
            if (Client.Client.Connected)
            {
                ...
                string Destination = @"C:\Users\PhyMo\Source\repos\P1\File Management\Data\";
                ...
                {
                    using (FileStream fs = new FileStream(Destination + Client.Name + "_" + Client.Id + "_" + DateAndTime + ".csv", FileMode.Create, FileAccess.Write))
                    {
