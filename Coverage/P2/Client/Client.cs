...
namespace _1
{
    class Client
    {
        ...
        private static void SendFile(TcpClient Client)
        {
            if (Client.Client.Connected)
            {
                string FilePath = @"C:\Users\PhyMo\Source\repos\P1\P1\File Management\Send\";
        ...
        private static void ReceiveFile(TcpClient Client)
        {
            if (Client.Client.Connected)
            {
                string Destination = @"C:\Users\PhyMo\Source\repos\P1\P1\File Management\Server Coverage\";
